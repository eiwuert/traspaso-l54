...
<div class="row">
	<div class="col-lg-12">
		...
		<div class="col-md-6 ">
			{{ Form::model($usuario, array('action' => array('Backend\UsuarioController@update', $usuario->id), 'method' => 'PUT')) }}
				...
				<div class="form-group">
					...
					{{ Form::text('rut', Input::old('nombres'), array('class' => 'form-control')) }}
				</div>

				<div class="form-group">
					{{ Form::label('institucion_id', 'Institucion') }}
					{{ Form::select('institucion_id', $instituciones, Input::old('institucion_id'), array('class' => 'form-control')) }}
				</div>
